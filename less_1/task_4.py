...
Значит вычисляем рентабельность выручки (соотношение прибыли к
выручке)
...
if result > 0:
    ...
    val = int(input("Введите численность сотрудников фирмы: "))
    profit = result / val
    print(f"Прибыль фирмы в расчете на одного сотрудника = {profit}")
elif result == 0:
    print("Финансовый результат деятельности фирмы равен нулю.")
else:
    print(f"Финансовый результат - убыток. Его величина: {result}")
